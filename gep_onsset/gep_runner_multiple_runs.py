...
if choice == 1:
    ...
    for country in countries:
        ...
        specs_path = 'C:/Users/adm.esa/Desktop/GEP running folder/{}-1/inputs/{}-1-specs.xlsx'.format(country, country)
        base_dir = 'C:/Users/adm.esa/Desktop/GEP running folder/{}-1/inputs/{}-1-country-inputs.csv'.format(country, country)
        output_dir = 'C:/Users/adm.esa/Desktop/GEP running folder/{}-1/outputs/{}-1-scenarios-results'.format(country, country)
        output_dir_summaries = 'C:/Users/adm.esa/Desktop/GEP running folder/{}-1/outputs/{}-1-scenarios-summaries'.format(country, country)
